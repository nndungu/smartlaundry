-- =========================================
-- TEST SEED FOR SmartLaundry API
-- =========================================

-- ===============================
-- ROLES (only if missing)
-- ===============================
...
VALUES
  ('test_admin', 'admin_test@example.com', '+254700000101', '$2y$10$hashedadmin', 1, 'ACTIVE', TRUE),
  ('test_driver1', 'driver_test1@example.com', '+254700000102', '$2y$10$hasheddriver1', 2, 'ACTIVE', TRUE),
  ('test_driver2', 'driver_test2@example.com', '+254700000103', '$2y$10$hasheddriver2', 2, 'ACTIVE', TRUE),
  ('test_customer1', 'customer_test1@example.com', '+254700000104', '$2y$10$hashedcustomer1', 3, 'ACTIVE', TRUE),
  ('test_customer2', 'customer_test2@example.com', '+254700000105', '$2y$10$hashedcustomer2', 3, 'ACTIVE', TRUE)
