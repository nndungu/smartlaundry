...
-- USERS
-- ============================
INSERT INTO app_user (username, email, phone, password_hash, role_id, status) VALUES
                                                                                  ('admin', 'admin@laundromart.ke', '+254700000001',
                                                                                   '$2y$10$UQYBk/NhI37lPRSZHgWHtej2u0gd0sY.NX2GjJkAgoHsCzWYeSEHG', 1, 'ACTIVE'),
                                                                                  ('owner', 'owner@laundromart.ke', '+254700000010',
                                                                                   '$2y$10$V5itNrn7s.p0AZgjktf.r.pKJ/Di4QGlxLKEbNVLPhDEmmk3LmDjC', 2, 'ACTIVE'),
                                                                                  ('staff1', 'staff1@laundromart.ke', '+254700000002',
                                                                                   '$2y$10$dsvqOKL2LoY1g6IqiPQw5enpCs9gq6mfFPe0wabR5HnBOJGLZoSea', 3, 'ACTIVE'),
                                                                                  ('driver1', 'driver1@laundromart.ke', '+254700000003',
                                                                                   '$2y$10$m7WO3ZHylX2aOONT7hzX0upnX1bnTOC0xWg/ci5eZtSoD8Tg82762', 4, 'ACTIVE'),
                                                                                  ('customer1', 'customer1@laundromart.ke', '+254700000004',
                                                                                   '$2y$10$/sMZXuXvzUHe.uQc14Bq4eshoE6U3/wdMXTVeggP0KcKl5IsiMEFG', 5, 'ACTIVE');
...
VALUES (1, 1, 5, 150), (1, 2, 3, 200);

-- ============================
-- PAYMENTS
-- ============================
INSERT INTO payment_provider (code, name) VALUES
                                              ('MPESA', 'Safaricom M-Pesa'), ('STRIPE', 'Stripe');
