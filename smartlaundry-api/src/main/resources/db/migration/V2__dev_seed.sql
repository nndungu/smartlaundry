-- ============================================================
-- SMARTLAUNDRY DEV SEED DATA (Cleaned & Hashed Passwords)
-- ============================================================
...
VALUES
    (1, 'admin', 'admin@dev.smartlaundry', '+254700000001',
     '$2a$12$u5Z3nvH/E3JxYbLzZXY.uuyFyYcV95xG.Zh9GDSxL6zT9GFbfZoCy', 1, 'ACTIVE', TRUE),
    (2, 'driver1', 'driver1@dev.smartlaundry', '+254700000002',
     '$2a$12$yM3K9yH/3sJGkX7v0N9tZeTtKj3bFx1pWnqYExiM6pFv0F0iH1n4O', 2, 'ACTIVE', TRUE),
    (3, 'customer1', 'customer1@dev.smartlaundry', '+254700000003',
     '$2a$12$M7g7/jlDkG5x0L8Q8Yxq7eA4VhS5qE9mU3y5P0vH7rZ2dX5Q6f1zW', 3, 'ACTIVE', TRUE),
    (4, 'customer2', 'customer2@dev.smartlaundry', '+254700000004',
     '$2a$12$P6d8/kjFvH8y1T7R9Zxw3fB5NkR2mG6oL4p7XyQ8rY1vH9W0J3t5L', 3, 'ACTIVE', TRUE)
ON CONFLICT (id) DO NOTHING;
